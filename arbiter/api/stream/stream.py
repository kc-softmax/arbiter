...
from arbiter.api.broker import ArbiterBroker
...
class ArbiterStream:
    ...
    async def connect(self, websocket: WebSocket, token: str) -> Tuple[str, str]:
        ...
        try:
            ...
            self.connection = ArbiterConnection(websocket, user)
            ...
            await self.connection.run(self.receive_message)
